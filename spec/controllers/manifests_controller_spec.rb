...
RSpec.describe ManifestsController, type: :controller do
  ...
  describe '#destroy' do
    setup do
      ...
      @labware_type = FactoryBot.create :labware_type, num_of_cols: 1,
                                                       num_of_rows: 1
    end
    ...
    it 'deletes the manifest and labwares' do
      ...
      @labware = Labware.create(manifest: @manifest, labware_index: 1, barcode: 'AKER-1', print_count: 1, contents: { "1": { id: @material_uuid.to_s } })
